    ...
    <div className='text-white flex items-center flex-col'>
      ...
      <div>
        ...
        <div className='w-full flex gap-5 mt-5'>
          ...
          >
            <img className='w-[20px] h-[20px]' src="/assets/reload.png" alt="" />
            <p>Check</p>
          </button>
          ...
          >
            <img className='w-[20px] h-[20px]' src="/assets/clear.png" alt="" />
            <p>Clear</p>
          </button>
...

          {
              isLoggedin ? (
                ...
                <img className='w-[25px] h-[25px]' src="/assets/save.png" alt="" />
